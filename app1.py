...
def main():
    ...
    st.set_page_config(page_title="Model uczący przeżycie katastrofy")
    overview = st.container()
    left, right = st.columns(2)
    prediction = st.container()

    st.image("https://ocdn.eu/pulscms-transforms/1/DbEk9kuTURBXy80MDkyYzUyYy01Njc3LTQ3NDQtOWM5Mi02NjMxNWFiNzE0OTguanBlZ5OVAwAdzQsezQZAkwmmNzk0OWQxBpMFzQSwzQJ2gaEwAQ/wlochy-10-rocznica-katastrofy-statku-costa-concordia-u-brzegow-wyspy-giglio.jpg")

    with overview:
        st.title("Model uczący przeżycie katastrofy")
